...
const links = [
  ...
  { to: `${base}/postulaciones`, label: "Mis postulaciones", icon: <School /> },
  { to: `${base}/documentos`, label: "Mis documentos", icon: <Description /> },
  ...
  return (
    <Box sx={{ width: 260, bgcolor: "white", borderRight: "1px solid #eee", p: 2, display: "flex", flexDirection: "column" }}>
      <Box sx={{ textAlign: "center", py: 2 }}>
        ...
        <Typography fontWeight={700}>Aspirante · UTE Admisiones</Typography>
