...
export default function EmpleadosPage() {
  ...
  const save = () => {
    ...
    (sel ? s.updateEmpleado(sel.id_empleado, form) : s.createEmpleado(form as any))
  ...
  return (
    <>
      <DataTable title="Empleados (Asesores)" columns={cols} rows={items} total={total} page={page} rowsPerPage={limit}
        ...
        onDelete={del} getId={(r) => r.id_empleado} />
